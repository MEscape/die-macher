...
public record PriceData(
    ...
    public PriceData(Instant startTimestamp, Instant endTimestamp,
                     double totalCost, double priceInEurPerKwh, String startTimeFormatted, String endTimeFormatted, Map<String, String> metadata) {
    ...
    public static class Builder {
        ...
        public PriceData build() {
            return new PriceData(startTimestamp, endTimestamp, totalCost, priceInEurPerKwh, startTimeFormatted, endTimeFormatted, metadata);
        }
    }
}
