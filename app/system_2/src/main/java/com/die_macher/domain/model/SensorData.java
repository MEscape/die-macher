...
public record SensorData(String sensorId, SensorType type, Double value, String unit, Instant timestamp,
                         Map<String, String> metadata) {
    public SensorData(String sensorId, SensorType type, Double value,
                      String unit, Instant timestamp, Map<String, String> metadata) {
