...
public class InboundEndpoint {
    ...
    private final AtomicInteger cubeIdCounter = new AtomicInteger(1);
    ...
    public void processImageMessage(Message<byte[]> message) {
        ...
        try {
            ...
            int cubeId = cubeIdCounter.getAndIncrement();

            // Publish color detected event
            eventPublisher.publishEvent(new ImageReceivedEvent(this, image, cubeId));
