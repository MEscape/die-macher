...
/**
 * Represents electricity market data from Awattar API. Contains a list of market prices for
...
public class MarketData {
  ...
  public static class MarketPrice {
    ...
    @Setter private long endTimestamp;
    @Setter private double marketprice;
    @Setter private String unit;

    /**
     * Helper methods for formatting Returns the formatted start time.
     *
    ...
    private String formatTimestamp(long timestamp) {
      LocalDateTime dateTime =
          LocalDateTime.ofInstant(Instant.ofEpochMilli(timestamp), ZoneId.of("Europe/Vienna"));
      return dateTime.format(DateTimeFormatter.ofPattern("dd.MM.yyyy HH:mm"));
    }

    /**
     * Conversion from EUR/MWh to EUR/kWh Returns the price in EUR per kWh.
     *
