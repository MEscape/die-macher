...
/**
 * REST controller for handling Awattar electricity market data requests. This controller provides
 * endpoints to access electricity market prices and optimal production windows based on price data.
 */
@RestController
...
public class AwattarController {
   ...
   *
   * @return ResponseEntity containing the current market price if available, or a 404 Not Found
   *     response
   */
   ...
   *
   * @return ResponseEntity containing the optimal production window if available, or a 404 Not
   *     Found response
   */
