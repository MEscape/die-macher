...
public class ExecuteQueueCommand extends AbstractDobotCommand<Boolean> {
    @Override
    protected byte[] createMessage() {
        return DobotMessageFactory.createSetQueuedCmdStartExecMessage();
    }

    @Override
    protected DobotProtocol.Commands getCommandType() {
        return DobotProtocol.Commands.SET_QUEUED_CMD_START_EXEC;
    }
