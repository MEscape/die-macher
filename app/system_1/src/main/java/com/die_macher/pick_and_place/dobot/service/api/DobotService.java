...
public interface DobotService {
     ...
     * Closes the communication link and releases resources.
     */
    ...
    /**
     * Pings the Dobot to verify communication.
     * Sends a low-level command to validate the connection.
     *
     ...
     * Allows customization of velocities and accelerations for precise control.
     *
    ...
    /**
     * Configures the jump trajectory parameters for
     * point-to-point (PTP) jump movements on the Dobot.
     *
