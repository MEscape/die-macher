...
public class ColorDetectionService {
    ...
    private static final int MIN_BRIGHTNESS_THRESHOLD = 150;
    private static final double YELLOW_RED_GREEN_MIN_PERCENT = 0.3;
    private static final double YELLOW_BLUE_MAX_PERCENT = 0.25;
    private static final double YELLOW_BALANCE_TOLERANCE = 0.15;
    private static final double YELLOW_DOMINANCE_THRESHOLD = 0.75;
