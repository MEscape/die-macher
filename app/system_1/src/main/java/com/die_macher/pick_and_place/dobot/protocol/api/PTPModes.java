package com.die_macher.pick_and_place.dobot.protocol.api;

import lombok.Getter;

@Getter
public enum PTPModes {
  ...
  MOVL_INC(
      7), // MOVL mode, (x,y,z,r) is the Cartesian coordinate increment in Joint coordinate system
  MOVJ_XYZ_INC(
      8); // MOVJ mode, (x,y,z,r) is the Cartesian coordinate increment in Cartesian coordinate
