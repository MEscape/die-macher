...
/**
 * Factory for creating and executing Dobot commands. Encapsulates the command pattern
 * implementation and provides a convenient API for the service layer to interact with the Dobot.
 */
@Component
public class DobotCommandExecutor {
  ...
  public boolean moveToPosition(
      ...
      throws DobotCommunicationException {
   ...
   *
   * @param jumpHeight The fixed height to lift the arm before jumping to the target position (in
   *     mm).
   ...
   * @throws DobotCommunicationException if communication with the device fails
   */
  public boolean setLiftHeight(float jumpHeight, float maxHeight, boolean isQueued)
      throws DobotCommunicationException {
   ...
   * @throws DobotCommunicationException if communication with the device fails
   */
  public boolean setVacuumState(boolean isSucked, boolean isQueued)
      throws DobotCommunicationException {
   ...
   * @throws DobotCommunicationException if communication with the device fails
   */
  public boolean setDefaultHomeCommand(float x, float y, float z, float r, boolean isQueued)
      throws DobotCommunicationException {
