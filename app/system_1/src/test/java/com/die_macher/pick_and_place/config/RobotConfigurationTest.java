...
class RobotConfigurationTest {
    ...
    void setUp() {
        ...
        validPositions = new RobotConfiguration.RobotPositions(
        ...
        validPhysicalConstants = new RobotConfiguration.PhysicalConstants(0f, 2.5f, 1f);
    }
    ...
    class MovementProfileTests {
        ...
        void shouldCreateValidMovementProfile() {
            RobotConfiguration.MovementProfile profile = new RobotConfiguration.MovementProfile(100, 200, 300, 400);

            Set<ConstraintViolation<RobotConfiguration.MovementProfile>> violations = validator.validate(profile);
            assertTrue(violations.isEmpty());
        ...
        void shouldAcceptMinimumValidValues() {
            RobotConfiguration.MovementProfile profile = new RobotConfiguration.MovementProfile(1, 1, 1, 1);
        ...
        void shouldAcceptMaximumValidValues() {
            RobotConfiguration.MovementProfile profile = new RobotConfiguration.MovementProfile(1000, 1000, 1000, 1000);
    ...
    class RobotPositionsTests {
        ...
        void shouldCreateValidRobotPositions() {
            Set<ConstraintViolation<RobotConfiguration.RobotPositions>> violations = validator.validate(validPositions);
            assertTrue(violations.isEmpty());
        ...
        void shouldFailValidationWhenStartPointIsNull() {
            RobotConfiguration.RobotPositions positions = new RobotConfiguration.RobotPositions(
                    null, validPositions.pickupPoint(), validPositions.camera(),
                    validPositions.red(), validPositions.green(), validPositions.blue(), validPositions.yellow()
            );

            Set<ConstraintViolation<RobotConfiguration.RobotPositions>> violations = validator.validate(positions);
            assertFalse(violations.isEmpty());
            assertTrue(violations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("startPoint")));
        }
        ...
        void shouldFailValidationWhenPickupPointIsNull() {
            RobotConfiguration.RobotPositions positions = new RobotConfiguration.RobotPositions(
                    validPositions.startPoint(), null, validPositions.camera(),
                    validPositions.red(), validPositions.green(), validPositions.blue(), validPositions.yellow()
            );

            Set<ConstraintViolation<RobotConfiguration.RobotPositions>> violations = validator.validate(positions);
            assertFalse(violations.isEmpty());
            assertTrue(violations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("pickupPoint")));
        }
        ...
        void shouldFailValidationWhenCameraIsNull() {
            RobotConfiguration.RobotPositions positions = new RobotConfiguration.RobotPositions(
                    validPositions.startPoint(), validPositions.pickupPoint(), null,
                    validPositions.red(), validPositions.green(), validPositions.blue(), validPositions.yellow()
            );

            Set<ConstraintViolation<RobotConfiguration.RobotPositions>> violations = validator.validate(positions);
            assertFalse(violations.isEmpty());
            assertTrue(violations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("camera")));
        }
        ...
        void shouldFailValidationWhenRedIsNull() {
            RobotConfiguration.RobotPositions positions = new RobotConfiguration.RobotPositions(
                    validPositions.startPoint(), validPositions.pickupPoint(), validPositions.camera(),
                    null, validPositions.green(), validPositions.blue(), validPositions.yellow()
            );
        ...
        void shouldFailValidationWhenGreenIsNull() {
            RobotConfiguration.RobotPositions positions = new RobotConfiguration.RobotPositions(
                    validPositions.startPoint(), validPositions.pickupPoint(), validPositions.camera(),
                    validPositions.red(), null, validPositions.blue(), validPositions.yellow()
            );
        ...
        void shouldFailValidationWhenBlueIsNull() {
            RobotConfiguration.RobotPositions positions = new RobotConfiguration.RobotPositions(
                    validPositions.startPoint(), validPositions.pickupPoint(), validPositions.camera(),
                    validPositions.red(), validPositions.green(), null, validPositions.yellow()
            );
        ...
        void shouldFailValidationWhenYellowIsNull() {
            RobotConfiguration.RobotPositions positions = new RobotConfiguration.RobotPositions(
                    validPositions.startPoint(), validPositions.pickupPoint(), validPositions.camera(),
                    validPositions.red(), validPositions.green(), validPositions.blue(), null
            );

            Set<ConstraintViolation<RobotConfiguration.RobotPositions>> violations = validator.validate(positions);
            assertFalse(violations.isEmpty());
            assertTrue(violations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("yellow")));
        }
    }
    ...
    class PhysicalConstantsTests {
        ...
        void shouldCreateValidPhysicalConstants() {
            Set<ConstraintViolation<RobotConfiguration.PhysicalConstants>> violations = validator.validate(validPhysicalConstants);
            assertTrue(violations.isEmpty());
        ...
        void shouldCreatePhysicalConstantsWithDifferentValues() {
            RobotConfiguration.PhysicalConstants constants = new RobotConfiguration.PhysicalConstants(-5.5f, 10.25f, 0.75f);

            Set<ConstraintViolation<RobotConfiguration.PhysicalConstants>> violations = validator.validate(constants);
            assertTrue(violations.isEmpty());
    ...
    class RecordEqualityTests {
        ...
        void shouldHaveProperEqualityForRobotConfiguration() {
            RobotConfiguration config1 = new RobotConfiguration(
                    validFastMovement, validSlowMovement, validPositions, validPhysicalConstants
            );
            RobotConfiguration config2 = new RobotConfiguration(
                    validFastMovement, validSlowMovement, validPositions, validPhysicalConstants
            );
        ...
        void shouldHaveProperEqualityForMovementProfile() {
            RobotConfiguration.MovementProfile profile1 = new RobotConfiguration.MovementProfile(100, 200, 300, 400);
            RobotConfiguration.MovementProfile profile2 = new RobotConfiguration.MovementProfile(100, 200, 300, 400);
