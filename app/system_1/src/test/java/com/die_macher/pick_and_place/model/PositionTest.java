...
class PositionTest {
    ...
    void shouldHandleMaximumFloatValues() {
        Position position = new Position(Float.MAX_VALUE, Float.MAX_VALUE, Float.MAX_VALUE, Float.MAX_VALUE);
    ...
    void shouldHandleVerySmallFloatValues() {
        Position position = new Position(Float.MIN_VALUE, Float.MIN_VALUE, Float.MIN_VALUE, Float.MIN_VALUE);
    ...
    void shouldHandleInfinityValues() {
        Position positiveInf = new Position(Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY,
                Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY);
        Position negativeInf = new Position(Float.NEGATIVE_INFINITY, Float.NEGATIVE_INFINITY,
