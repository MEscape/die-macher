...
class DobotMessageFactoryTest {
  ...
  void testCreateGetDeviceSNMessage() {
    ...
    assertEquals(
        DobotProtocol.Commands.GET_DEVICE_SN.getValue(),
        message[DobotProtocol.Indices.COMMAND_INDEX],
        "Der Befehlsindex sollte GET_DEVICE_SN sein");
    assertEquals(
        0x00,
        message[DobotProtocol.Indices.CONTROL_INDEX],
  ...
  void testCreateGetDeviceNameMessage() {
    ...
    assertNotNull(message, "Die erstellte Nachricht sollte nicht null sein");
    assertEquals(
        DobotProtocol.Commands.GET_DEVICE_NAME.getValue(),
        message[DobotProtocol.Indices.COMMAND_INDEX],
  ...
  void testCreateSetPTPCmdMessage() {
    ...
    // Act
    byte[] message =
        DobotMessageFactory.createSetPTPCmdMessage(PTPModes.MOVJ_XYZ, x, y, z, r, isQueued);

    // Assert
    assertNotNull(message, "Die erstellte Nachricht sollte nicht null sein");
    assertEquals(
        DobotProtocol.Commands.SET_PTP_CMD.getValue(),
        message[DobotProtocol.Indices.COMMAND_INDEX],
    ...
    assertEquals(
        2 + 1 + 16,
        message[DobotProtocol.Indices.LENGTH_INDEX],
  ...
  void testCreateSetHomeCmdMessage() {
    ...
    assertNotNull(message, "Die erstellte Nachricht sollte nicht null sein");
    assertEquals(
        DobotProtocol.Commands.SET_HOME_CMD.getValue(),
        message[DobotProtocol.Indices.COMMAND_INDEX],
  ...
  void testCreateSetEndEffectorSuctionCupMessage() {
    ...
    assertNotNull(message, "Die erstellte Nachricht sollte nicht null sein");
    assertEquals(
        DobotProtocol.Commands.SET_END_EFFECTOR_SUCTION_CUP.getValue(),
        message[DobotProtocol.Indices.COMMAND_INDEX],
    ...
    assertEquals(
        0x01,
        message[DobotProtocol.Indices.PAYLOAD_INDEX],
        "Der erste Boolean-Wert sollte 1 sein (true)");
    assertEquals(
        0x01,
        message[DobotProtocol.Indices.PAYLOAD_INDEX + 1],
  ...
  void testCreateQueueControlMessages() {
    ...
    assertEquals(
        (byte) DobotProtocol.Commands.SET_QUEUED_CMD_START_EXEC.getValue(),
        startMessage[DobotProtocol.Indices.COMMAND_INDEX],
        "Der Befehlsindex sollte SET_QUEUED_CMD_START_EXEC sein");
    assertEquals(
        0x01,
        startMessage[DobotProtocol.Indices.CONTROL_INDEX],
    ...
    assertEquals(
        (byte) DobotProtocol.Commands.SET_QUEUED_CMD_STOP.getValue(),
        stopMessage[DobotProtocol.Indices.COMMAND_INDEX],
        "Der Befehlsindex sollte SET_QUEUED_CMD_STOP sein");
    assertEquals(
        0x01,
        stopMessage[DobotProtocol.Indices.CONTROL_INDEX],
        "Der Steuerungsbyte sollte 0x01 sein (Schreiben, nicht in Warteschlange)");
    ...
    assertEquals(
        (byte) DobotProtocol.Commands.SET_QUEUED_CMD_CLEAR.getValue(),
        clearMessage[DobotProtocol.Indices.COMMAND_INDEX],
        "Der Befehlsindex sollte SET_QUEUED_CMD_CLEAR sein");
    assertEquals(
        0x01,
        clearMessage[DobotProtocol.Indices.CONTROL_INDEX],
        "Der Steuerungsbyte sollte 0x01 sein (Schreiben, nicht in Warteschlange)");
  }
  ...
  void testCreateSetHomeParamsMessage() {
    // Act
    byte[] message =
        DobotMessageFactory.createSetHomeParamsMessage(137.8012F, 148.6876F, 29.1770F, 0.0F, true);

    // Assert
    assertNotNull(message, "Die erstellte Nachricht sollte nicht null sein");
    assertEquals(
        DobotProtocol.Commands.SET_HOME_PARAMS.getValue(),
        message[DobotProtocol.Indices.COMMAND_INDEX],
  ...
  void testCreatePTPConfigMessages() {
    ...
    byte[] coordMessage =
        DobotMessageFactory.createSetPTPCoordinateParamsMessage(
    ...
    assertEquals(
        DobotProtocol.Commands.SET_PTP_COORDINATE_PARAMS.getValue(),
    ...
    assertEquals(
        velocity, coordBuffer.getFloat(), 0.001f, "XYZ-Geschwindigkeit sollte korrekt sein");
    assertEquals(velocity, coordBuffer.getFloat(), 0.001f, "R-Geschwindigkeit sollte korrekt sein");
    assertEquals(
        acceleration, coordBuffer.getFloat(), 0.001f, "XYZ-Beschleunigung sollte korrekt sein");
    assertEquals(
        acceleration, coordBuffer.getFloat(), 0.001f, "R-Beschleunigung sollte korrekt sein");

    // Act & Assert für Jump-Parameter
    byte[] jumpMessage =
        DobotMessageFactory.createSetPTPJumpParamsMessage(jumpHeight, maxHeight, isQueued);
    assertNotNull(jumpMessage, "Die Jump-Parameter-Nachricht sollte nicht null sein");
    assertEquals(
        DobotProtocol.Commands.SET_PTP_JUMP_PARAMS.getValue(),
  ...
  void testCreateSetDeviceNameMessage() {
    ...
    assertNotNull(message, "Die erstellte Nachricht sollte nicht null sein");
    assertEquals(
        DobotProtocol.Commands.SET_DEVICE_NAME.getValue(),
        message[DobotProtocol.Indices.COMMAND_INDEX],
    ...
    System.arraycopy(
        message, DobotProtocol.Indices.PAYLOAD_INDEX, actualPayload, 0, expectedPayload.length);
    assertArrayEquals(
        expectedPayload, actualPayload, "Die Payload sollte den Gerätenamen als Bytes enthalten");
  }
}
