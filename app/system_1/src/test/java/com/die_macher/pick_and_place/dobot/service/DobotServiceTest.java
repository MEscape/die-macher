...
class DobotServiceTest {
    ...
    void testSetMovementConfig() throws DobotCommunicationException {
        ...
        boolean isQueued = true;
        when(commandExecutor.setMovementConfig(xyzVelocity, rVelocity, xyzAcceleration, rAcceleration, isQueued))
                .thenReturn(true);
        ...
        // Assert
        assertTrue(result);
        verify(commandExecutor).setMovementConfig(xyzVelocity, rVelocity, xyzAcceleration, rAcceleration, isQueued);
    }
