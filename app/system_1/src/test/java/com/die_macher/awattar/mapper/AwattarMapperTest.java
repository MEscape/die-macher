...
class AwattarMapperTest {
    ...
    void toDto_WhenMarketDataIsValid_ShouldConvertCorrectly() {
        ...
        assertEquals(OBJECT_TYPE, result.getObject(), "Das Objekt-Feld sollte korrekt übertragen werden");
        ...
        assertEquals(START_TIMESTAMP, firstPrice.getStart_timestamp(), "Der Start-Timestamp sollte korrekt übertragen werden");
        assertEquals(END_TIMESTAMP, firstPrice.getEnd_timestamp(), "Der End-Timestamp sollte korrekt übertragen werden");
        assertEquals(MARKET_PRICE, firstPrice.getMarketprice(), "Der Marktpreis sollte korrekt übertragen werden");
    ...
    void toDto_WhenMarketPriceIsValid_ShouldConvertCorrectly() {
        ...
        // Assert
        assertNotNull(result, "Das Ergebnis sollte nicht null sein");
        assertEquals(START_TIMESTAMP, result.getStart_timestamp(), "Der Start-Timestamp sollte korrekt übertragen werden");
        assertEquals(END_TIMESTAMP, result.getEnd_timestamp(), "Der End-Timestamp sollte korrekt übertragen werden");
        assertEquals(MARKET_PRICE, result.getMarketprice(), "Der Marktpreis sollte korrekt übertragen werden");
    ...
    void toModel_WhenMarketDataDtoIsValid_ShouldConvertCorrectly() {
        ...
        assertEquals(START_TIMESTAMP, firstPrice.getStartTimestamp(), "Der Start-Timestamp sollte korrekt übertragen werden");
        assertEquals(END_TIMESTAMP, firstPrice.getEndTimestamp(), "Der End-Timestamp sollte korrekt übertragen werden");
        assertEquals(MARKET_PRICE, firstPrice.getMarketprice(), "Der Marktpreis sollte korrekt übertragen werden");
        assertEquals(UNIT, firstPrice.getUnit(), "Die Einheit sollte korrekt übertragen werden");
    }

    @Test
    @DisplayName("toModel(MarketDataDto) sollte korrekt konvertieren, wenn MarketDataDto.data null ist")
    ...
    @Test
    @DisplayName("toModel(MarketPriceDto) sollte korrekt konvertieren, wenn MarketPriceDto gültig ist")
    void toModel_WhenMarketPriceDtoIsValid_ShouldConvertCorrectly() {
        ...
        // Assert
        assertNotNull(result, "Das Ergebnis sollte nicht null sein");
        assertEquals(START_TIMESTAMP, result.getStartTimestamp(), "Der Start-Timestamp sollte korrekt übertragen werden");
        assertEquals(END_TIMESTAMP, result.getEndTimestamp(), "Der End-Timestamp sollte korrekt übertragen werden");
        assertEquals(MARKET_PRICE, result.getMarketprice(), "Der Marktpreis sollte korrekt übertragen werden");
        assertEquals(UNIT, result.getUnit(), "Die Einheit sollte korrekt übertragen werden");
    }

    @Test
    @DisplayName("toDto(OptimalProductionWindow) sollte null zurückgeben, wenn OptimalProductionWindow null ist")
    ...
    @Test
    @DisplayName("toDto(OptimalProductionWindow) sollte korrekt konvertieren, wenn OptimalProductionWindow gültig ist")
    void toDto_WhenOptimalProductionWindowIsValid_ShouldConvertCorrectly() {
        ...
        assertEquals(START_TIMESTAMP, result.getStartTimestamp(), "Der Start-Timestamp sollte korrekt übertragen werden");
        assertEquals(END_TIMESTAMP, result.getEndTimestamp(), "Der End-Timestamp sollte korrekt übertragen werden");
        assertEquals(TOTAL_COST, result.getTotalCost(), "Die Gesamtkosten sollten korrekt übertragen werden");
        assertEquals(PRICE_IN_EUR_PER_KWH, result.getPriceInEurPerKwh(), "Der Preis in EUR/kWh sollte korrekt übertragen werden");
        assertNotNull(result.getStartTimeFormatted(), "Die formatierte Startzeit sollte nicht null sein");
    ...
    @Test
    @DisplayName("toDto(OptimalProductionWindow) sollte korrekt konvertieren, wenn OptimalProductionWindow.prices null ist")
    ...
    private MarketDataDto createMarketDataDto() {
        ...
        List<MarketPriceDto> prices = Arrays.asList(
