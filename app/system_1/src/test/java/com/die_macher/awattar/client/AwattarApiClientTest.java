...
class AwattarApiClientTest {
    ...
    void fetchMarketDataFor_WhenApiCallSucceeds_ShouldReturnMarketData() {
        ...
        ResponseEntity<MarketDataDto> responseEntity = new ResponseEntity<>(expectedData, HttpStatus.OK);
    ...
    void fetchMarketDataFor_ShouldCreateCorrectUrlWithStartAndEndParameters() {
        ...
        assertTrue(capturedUrl.contains("start=" + START_MILLIS), "URL sollte den korrekten Start-Parameter enthalten");
        assertTrue(capturedUrl.contains("end=" + END_MILLIS), "URL sollte den korrekten End-Parameter enthalten");
    }
    ...
    void fetchMarketDataFor_WhenHttpClientErrorExceptionOccurs_ShouldReturnNull() {
        ...
        // Assert
        assertNull(result, "Das Ergebnis sollte null sein, wenn eine HttpClientErrorException auftritt");
    ...
    void fetchMarketDataFor_ShouldCalculateCorrectEndTime() {
        ...
        String capturedUrl = urlCaptor.getValue();
        assertTrue(capturedUrl.contains("end=" + END_MILLIS), 
