...
/**
 * Unit tests for the DobotConfig class.
 * Tests the Spring bean configuration and initialization.
 */
@SpringBootTest
public class DobotConfigTest {
    ...
    public void testDobotSerialConnectorBeanCreation() {
        // Arrange & Act
    ...
    public void testDobotSerialConnectorMethod() {
        // Arrange
        ...
        assertTrue(connector instanceof DobotSerialConnector, "Should return an instance of DobotSerialConnector");
    }
    
    @Test
    @DisplayName("Should create different instances when called multiple times")
    public void testDobotSerialConnectorMultipleInstances() {
        // Arrange
        DobotConfig config = new DobotConfig();
