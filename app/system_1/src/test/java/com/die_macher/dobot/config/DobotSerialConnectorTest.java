...
/**
 * Unit tests for the DobotSerialConnector class.
 * Tests the serial port connection, data sending and receiving functionality.
 */
@ExtendWith(MockitoExtension.class)
public class DobotSerialConnectorTest {
    ...
    public void testConnectSuccess() {
        ...
        try (MockedStatic<SerialPort> serialPortMockedStatic = mockStatic(SerialPort.class)) {
            ...
            verify(serialPort).setComPortTimeouts(eq(SerialPort.TIMEOUT_READ_SEMI_BLOCKING), eq(timeout), eq(timeout));
    ...
    public void testSendDataWithIOException() throws IOException {
    ...
    public void testReadResponseFailure() throws IOException {
