...
/**
 * Unit-Tests für die DobotMessageBuilder-Klasse.
 * Diese Tests überprüfen die korrekte Erstellung von Dobot-Protokollnachrichten.
 */
public class DobotMessageBuilderTest {

    @Test
    @DisplayName("Sollte eine Nachricht mit Befehl, aber ohne Payload erstellen")
    public void testBuildMessageWithoutPayload() {
        // Arrange
    ...
    public void testBuildMessageWithNullPayload() {
        // Arrange
    ...
    public void testControlByteVariations() {
        // Arrange & Act
